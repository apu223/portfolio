...
const MyExperience = () => {
  return (
    <div className="mx-6 lg:mx-52 items-center justify-center text-center lg:bg-violet-100 lg:rounded-3xl  lg:mt-30 dark:lg:shadow-orange-50 dark:lg:bg-slate-700 lg:shadow-xl">
      <div className="grid grid-cols-2 lg:grid-cols-4 py-4 gap-y-8 lg:-mt-2 text-center">
        <div className="flex flex-col items-center justify-center lg:flex-row" data-aos="zoom-in-up">
          <h1 className="text-4xl flex-row lg:flex font-bold lg:text-[64px] text-black dark:text-gray-50 ">
            <Counterpage /> <span className="hidden mt-9 lg:block">+</span>
          </h1>
        ...
        <div className="flex flex-col mt-10 items-center justify-center lg:flex-row lg:-mt-2" data-aos="zoom-in-up">
          <h1 className="text-4xl lg:flex  font-bold lg:text-[64px] text-black dark:text-gray-50 ">
            <Project /> <span className="hidden lg:block">+</span>
          </h1>
        ...
        <div className="flex flex-col mt-7 items-center justify-center lg:flex-row lg:-mt-2" data-aos="zoom-in-up">
          <h1 className="text-4xl sm:flex-row lg:flex lg:flex-row font-bold lg:text-[64px] text-black dark:text-gray-50">
            <Client /> <span className="hidden lg:block">+</span>
          </h1>
        ...
        <div className="flex flex-col -mt-4 items-center justify-center lg:flex-row" data-aos="zoom-in-up">
