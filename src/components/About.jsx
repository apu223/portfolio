...
const About = () => {
  ...
  return (
    <div
      id="About"
      className=" mx-2 lg:mx-72  items-center text-center px-8 sm:mt-32 md:mt-40 justify-center mt-24 lg:mt-44 dark:text-white"
      data-aos="zoom-in-up"
    >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 lg:mx-auto items-center justify-center my-20">
        ...
        <div className="flex items-center justify-center mt-5 lg:mt-0">
          <div className="">
            ...
            <div
              className=" items-center justify-start  mt-4"
              data-aos="zoom-in-up"
            >
              <img src={under} alt="under" />
            </div>
            <div
              className="flex flex-col lg:flex-col mt-2 lg:mt-5 lg:ml-4 items-start justify-start"
              data-aos="zoom-in-up"
            >
              <p className="flex mt-2 max-w-3xl mx-auto text-lg font-sans items-center justify-start text-gray-600 dark:text-gray-300 my-2">
                <FaLocationDot />
                <span className="mx-4">Dhaka, Bangladesh</span>
              </p>
              <p className="flex font-sans mt-2 max-w-3xl mx-auto text-lg items-center justify-start text-gray-600 dark:text-gray-300 my-2">
                <BsTelephoneOutboundFill />
                <span className="mx-4">01909280740</span>
              </p>
              <p className="flex font-sans mt-2 max-w-3xl mx-auto text-lg items-center justify-start text-gray-600 dark:text-gray-300">
                <MdMarkEmailUnread />
